    ...
    <div class="flex flex-col flex-1 gap-6 justify-between items-center px-8 pt-32 mx-auto w-full max-w-2xl text-center md:px-12 xl:px-20 lg:pt-32 lg:pb-16 lg:max-w-7xl lg:flex-row">
        <div class="w-full">
            <h1 class="text-6xl font-bold tracking-tighter text-center sm:text-7xl md:text-[84px] text-zinc-900 text-balance">
                {{ __('messages.home.hero_title_1') }} <span class="text-transparent bg-clip-text bg-gradient-to-b from-neutral-900 to-neutral-500">{{ __('messages.home.hero_title_2') }}</span>
            </h1>
            ...
            <div class="flex flex-col gap-3 justify-center items-center mx-auto mt-8 md:gap-2 md:flex-row">
                ...
                @guest
                <x-button size="lg" color="secondary" class="w-full md:w-auto" href="/join_us" tag="a">{{ __('messages.home.add_property') }}</x-button>
                ...
                @else
                <x-button size="lg" color="secondary" class="w-full md:w-auto" href="/property-listings/create" tag="a">{{ __('messages.home.add_property') }}</x-button>
